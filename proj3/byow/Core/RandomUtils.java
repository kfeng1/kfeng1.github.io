...
public class RandomUtils {
    ...
    /**
     * Returns whether a random real number from [0, 1) < p, like a probability check
     */
    public static boolean roll(Random random, double p) {
        return uniform(random) < p;
    }

    /**
     * Returns whether a random number from [0, range) < cutoff, like a DnD stat check.
     */
    public static boolean roll(Random random, int range, int cutoff) {
        return uniform(random, range) < cutoff;
    }
     ...
     */
    public static <T> T element(Random random, List<T> lst) {
        return lst.get(uniform(random, 0, lst.size()));
    }
     ...
     */
    public static <T> List<T> shuffle(Random random, List<T> lst) {
        int n = lst.size();
        for (int i = 0; i < n; i++) {
